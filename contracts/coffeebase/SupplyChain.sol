...
contract SupplyChain is Ownable{
  ...
  struct Item {
    ...
    uint    upc; // Universal Product Code (UPC), generated by threquire(items[_upc].itemState == State.Processed);e Farmer, goes on the package, can be verified by the Consumer
